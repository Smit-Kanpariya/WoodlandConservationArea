...
import { MapPin, Navigation, Home, Trees, Droplets, Clock, Compass } from 'lucide-react';
...
const SiteMap = () => {
  ...
  const siteFeatures = [
    ...
    },
    {
      ...
      audioText: 'Farmhouse Foundation. Archaeological remains of the original 1800s farmhouse. Click for more historical information.'
    },
    {
      id: 'well1',
      ...
      audioText: 'Historic Well Number 1. Original well from the farming settlement period.'
    },
    {
      id: 'well2',
      ...
      audioText: 'Historic Well Number 2. Secondary well structure, partially preserved.'
    },
    {
      id: 'sitting-area',
      name: 'Sitting Area',
      ...
      audioText: 'Sitting Area. Peaceful rest area with benches overlooking the wetland.'
    },
    {
      id: 'yellow-birch',
    ...
    },
    {
      ...
      audioText: 'Secondary Wetland. Smaller wetland connected to the primary system.'
    }
  ];
  ...
  const getFeatureColor = (type: string) => {
    switch (type) {
      case 'access': return 'text-accent';
      case 'historical': return 'text-destructive';
      case 'ecosystem': return 'text-primary';
  ...
  const getFeatureBackground = (type: string) => {
    switch (type) {
      case 'access': return 'bg-accent/20';
      case 'historical': return 'bg-destructive/20';
      case 'ecosystem': return 'bg-primary/20';
      case 'amenity': return 'bg-secondary/40';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
            Explore our conservation area with this interactive map showing trails, historical sites, 
            and key ecosystem features.
          </p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-foreground no-break">Access Points</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-primary/20 rounded-full mr-2"></div>
                  <span className="text-sm text-foreground no-break">Ecosystems</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-destructive/20 rounded-full mr-2"></div>
                  <span className="text-sm text-foreground no-break">Historical Sites</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-secondary/40 rounded-full mr-2"></div>
                  <span className="text-sm text-foreground no-break">Amenities</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-0">
              <div className="relative bg-gradient-to-br from-primary/10 to-accent/5 h-96 md:h-[500px]">
                ...
                {siteFeatures.map((feature) => (
                  ...
                  >
                    <div className={`w-8 h-8 ${getFeatureBackground(feature.type)} rounded-full flex items-center justify-center border-2 border-white shadow-md hover:shadow-lg`}>
                      <feature.icon className={`w-4 h-4 ${getFeatureColor(feature.type)}`} />
                    </div>
                ...
                <Card key={feature.id} className="event-card">
                  <CardContent className="p-8">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center">
                        <div className={`w-12 h-12 ${getFeatureBackground(feature.type)} rounded-full flex items-center justify-center mr-4`}>
                          <feature.icon className={`w-6 h-6 ${getFeatureColor(feature.type)}`} />
                        </div>
                        <div>
                    ...
                    {feature.id === 'farmhouse' && (
                      <div className="mt-6 p-4 bg-muted/30 rounded-lg">
                        <h4 className="font-semibold text-foreground mb-2 no-break">Historical Information</h4>
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          The farmhouse was built in the 1850s by the Morrison family, who farmed this land 
                          for three generations. The foundation stones were quarried locally and show evidence 
                          of traditional building techniques of the era. Archaeological surveys have revealed 
                          artifacts including pottery fragments, metal tools, and evidence of a root cellar.
                        </p>
                      </div>
                    )}
                  </CardContent>
